...
- Ljung-Box and LM tests suggest no significant autocorrelation between squared standardized residuals
...
- Every parameter is significant, except for intercept omega.
- No sign of autocorrelation in standardized residuals. There are some significant lags for squared standardized residuals, but the tests do not allow us to reject the null of no autocorrelation.
...
- There are no signs of serial correlation in the squared standardized residuals according to tests (except LM lag 3).
...
- GARCH(1) is insignificant
- ACF plot of squared std. residuals shows two significant lags, LB test has 8th lag rejecting the null, but LM tests fail to reject the null.
...
- GARCH(1) is highly significant confirming volatility persistence.
- The squared standardized residuals are not autocorellated (we fail to reject the null), according to the tests. 
...
- Apart from alpha2 and eta12, every parameter is significant.
- No sign of autocorrelation in standardized residuals. There are some significant lags for squared standardized residuals, but the tests do not allow us to reject the null of no autocorrelation.
...
- AR(2) and GARCH(1) are somehow insignificant.
- No sign of autocorrelation in standardized residuals. There is one significant lag for squared standardized residuals, but the tests do not allow us to reject the null of no autocorrelation.
